...
public class SignUpPage {
    public static final Target LOGIN = Target.the("Login").locatedBy("//a[@class='login']");
    ...
    public static final Target SIGN_IN = Target.the("Sign In Button").locatedBy("//button[contains(.,'Got it!')]");
