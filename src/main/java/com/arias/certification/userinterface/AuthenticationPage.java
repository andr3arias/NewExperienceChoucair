...
public class AuthenticationPage {
    ...
    public static final Target SIGN_IN_BUTTON = Target.the("Sign In Button").locatedBy("//*[@id='SubmitLogin']");
    public static final Target ERROR_MESSAGE = Target.the("Error Message {0}").locatedBy("//li[contains(.,'{0}')]");
    public static final Target RETURN_TO_HOME = Target.the("icon-home").locatedBy("//i[@class='icon-home']");
